...
# From the private key, generates a public key. This key will be used to 
# encrypt the one time password generated for each file's encryption. 
# This command will require the private key passphrase.
